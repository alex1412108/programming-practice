...
from:https://github.com/abidrahmank/OpenCV2-Python/blob/master/Official_Tutorial_Python_Codes/3_imgproc/boundingrect.py'''
...
img = cv2.imread('seedsflowerpattern.jpg')
